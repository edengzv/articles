---
title: Karpathy 两年全记录：从 llm.c 到 autoresearch，一个天才程序员的 AI 进化论
summary: Andrej Karpathy 离开 Tesla 后的 600 天，发布了 12 个开源项目，发表了 7 场重要演讲。这篇文章梳理了他对 AI 的所有核心判断，以及给程序员群体的启示。
author: 智见AI
concepts: [Karpathy, LLM, 开源, AI 观点]
---
